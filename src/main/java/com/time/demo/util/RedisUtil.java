...
public class RedisUtil {
     ...
     * @param key    传入的键
     * @param offset 位置
     * @param value  传入的值  值,true为1, false为0
     * @return 返回的结果
     */
     ...
     *
     * @param key   传入的键
     * @param value 传入的值 设置的值
     * @return 返回的结果 之前已经存在返回false, 不存在返回true
     */
