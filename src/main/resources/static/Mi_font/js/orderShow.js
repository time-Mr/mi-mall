...
function addShortcar() {
    ...
    if(name == null){
        ...
        $.ajax({
            type: "get",
            url: "http://10.168.1.135:10086/user/addShoppingCart",
            data: {
                name: name,
...
$(function () {
    ...
    $.ajax({
        type: "get",
        url: "http://10.168.1.135:10086/product/selectByProductName",
        data: {
        ...
        success: function (res) {
            ...
            $('.order_pic ul').append(`
                    <li>
                        <img src="http://10.168.1.135:10086/picture/${res.picture1}">
                    </li>
                `)
